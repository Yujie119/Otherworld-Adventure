...
const FX_TEX := preload("res://AI资源库/特效库/符文奥秘/fx.png")
const COLS := 7
const MODE := "single"
const GIZMO_COLOR := Color(0.550, 0.620, 1.000, 0.160)
const POINT_LIGHT_COLOR := Color(1.000, 1.000, 1.000, 1.000)

@export var spawn_rect_half_extents: Vector2 = Vector2(42, 42):
	set(v):
...
@export var spin_speed_range: Vector2 = Vector2(0.18, 0.18)
