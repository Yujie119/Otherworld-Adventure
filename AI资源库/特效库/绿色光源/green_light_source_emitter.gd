...
const FX_TEX := preload("res://AI资源库/特效库/绿色光源/fx.png")
const COLS := 7
const MODE := "light"
const GIZMO_COLOR := Color(0.350, 1.000, 0.320, 0.160)
const POINT_LIGHT_COLOR := Color(0.350, 1.000, 0.320, 1.000)

@export var spawn_rect_half_extents: Vector2 = Vector2(36, 36):
	set(v):
...
@export_range(0.05, 4.0, 0.01) var particle_scale_max: float = 0.78
@export_range(0.05, 4.0, 0.01) var single_scale: float = 0.9
...
@export_range(0.0, 3.0, 0.01) var light_energy: float = 0.48
@export_range(0.1, 5.0, 0.01) var light_texture_scale: float = 1.45
