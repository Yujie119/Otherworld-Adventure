...
const FX_TEX := preload("res://AI资源库/特效库/绿色毒液/fx.png")
const COLS := 7
const MODE := "single"
const GIZMO_COLOR := Color(0.300, 1.000, 0.120, 0.160)
...
@export_range(0.05, 4.0, 0.01) var particle_scale_min: float = 0.9
@export_range(0.05, 4.0, 0.01) var particle_scale_max: float = 0.9
