...
const FX_TEX := preload("res://AI资源库/特效库/蓝色光源/fx.png")
const COLS := 7
const MODE := "light"
const GIZMO_COLOR := Color(0.250, 0.780, 1.000, 0.160)
const POINT_LIGHT_COLOR := Color(0.250, 0.780, 1.000, 1.000)
...
@export_range(0.0, 3.0, 0.01) var light_energy: float = 0.55
@export_range(0.1, 5.0, 0.01) var light_texture_scale: float = 1.55
